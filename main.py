        ...
        if counter != 0:
            ...
            if modeType != 3:
                if counter <= 100:
                    ...
                    cv2.putText(imgBackground, str(studentInfo['stream']), (1006, 550), cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 255, 255), 1)
                    cv2.putText(imgBackground, str(id), (1006, 493), cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 255, 255), 1)
                    cv2.putText(imgBackground, str(studentInfo['gender']), (910, 625), cv2.FONT_HERSHEY_COMPLEX, 0.6, (100, 100, 100), 1)
                    cv2.putText(imgBackground, str(studentInfo['year']), (1020, 625), cv2.FONT_HERSHEY_COMPLEX, 0.6, (100, 100, 100), 1)
